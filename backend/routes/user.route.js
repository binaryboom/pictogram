...
router.route('/profile/:username').get(isAuthenticated,userController.getProfile)
router.route('/find/:username').get(isAuthenticated,userController.findUserByUsername)
